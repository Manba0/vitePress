...
![构造函数与实例原型的关系图](https://github.com/Manba0/vitePress/blob/main/docs/Images/prototype1.png?raw=true)
...
![实例与实例原型的关系图](https://github.com/Manba0/vitePress/blob/main/docs/Images/prototype2.png?raw=true)
...
![实例原型与构造函数的关系图](https://github.com/Manba0/vitePress/blob/main/docs/Images/prototype3.png?raw=true)
...
![原型的原型关系图](https://github.com/Manba0/vitePress/blob/main/docs/Images/prototype4.png?raw=true)
...
![原型链示意图](https://github.com/Manba0/vitePress/blob/main/docs/Images/prototype5.png?raw=true)
